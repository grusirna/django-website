...
def generate_cheatsheet(data):
  ...
  cheatsheet_file_path = os.path.join(ROOT_PATH, 'cheatsheet.tpl')
  template_path = os.path.join(BUILDER_PATH, 'cheatsheet', 'template.tpl')
  icon_row_path = os.path.join(BUILDER_PATH, 'cheatsheet', 'icon-row.tpl')
