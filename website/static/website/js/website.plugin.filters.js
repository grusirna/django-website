(function($) {
  ...
  $(function(){
    ...
    $('.menu-date-range form').each(function(){
      var el = $(this);
      var start_date = el.find('.calendar.date-start').datepicker({format: 'yyyy-mm-dd', language: 'website'});
      var end_date = el.find('.calendar.date-end').datepicker({format: 'yyyy-mm-dd', language: 'website'});
      console.log(end_date.data('datepicker'));
